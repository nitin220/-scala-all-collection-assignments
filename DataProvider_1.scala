...
class Manipulation(sourceStudent:List[Student],sourceMarks:List[List[List[Marks]]])
{
...
object DataProvider_1 
{
	...
	def main(args: Array[String]) 
	{
		...
		val student_7 = Student(7, "Nitin Aggarwal")
      ...
      val Marks_stud_1 = List(maths_1, science_1, hindi_1, Eng_1, comp_1)
		...
		val obj = new Manipulation(student_list, marks_list)
      
		val list_map=obj.generateMap()

		obj.generateScoreCard(list_map)
		val resultByName=obj.getScorecardByName("Nitin Aggarwal",list_map)
